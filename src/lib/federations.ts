/**
 * FIDE federation codes with their English country names.
 * Used to populate autocomplete lists in the UI.
 */
export const FIDE_FEDERATIONS: { code: string; name: string }[] = [
  ...
  { code: "TRI", name: "Trinidad and Tobago" },
