---
description: "Use when creating or modifying UI components, layouts, or visual styling. Enforces the design system's color palette, typography, elevation model, and component patterns."
applyTo: "src/**/*.astro,src/styles/**"
---
